...
| Utilizador delegou o resto das escolhas visuais | densidade compacta nas tabelas; a ordem por omissão é o default da API (`createdAt` desc) e o utilizador ordena pelos cabeçalhos | user delegated | y |
...
| screen `users-list` | densidade e ordenação | AC 13, AC 17 - densidade compacta; default `createdAt` desc da API, e cabeçalhos ordenáveis em `email`, `firstName` e `createdAt` |
...
| screen `roles-list` | densidade e ordenação | AC 24 - densidade compacta; default `createdAt` desc da API, e cabeçalho ordenável em `name` |
...
| screen `permissions-list` | densidade e ordenação | AC 32 - densidade compacta; default `createdAt` desc da API, e cabeçalho ordenável em `name` |
...
| screen `tenants-list` | densidade e ordenação | AC 33 - densidade compacta; default `createdAt` desc da API, e cabeçalhos ordenáveis em `tenantKey` e `displayName` |
