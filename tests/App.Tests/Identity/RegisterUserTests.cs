...
public sealed class RegisterUserTests
{
    ...
    [Fact]
    public async Task Handle_ShouldAllowImmediateLogin_WhenRegistered()
    {
        var provider = TestServiceFactory.CreateWithLogin(
            nameof(Handle_ShouldAllowImmediateLogin_WhenRegistered));
